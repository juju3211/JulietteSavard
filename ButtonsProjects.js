...
document.getElementById("slimeVerte").style.display = "none";
document.getElementById("laSortie").style.display = "none";
document.getElementById("piano").style.display = "none";
document.getElementById("myPieces").style.display = "none";
document.getElementById("firstPiece").style.display = "none";
document.getElementById("secondPiece").style.display = "none";